package prosayj.handwritten.mvcframework.servlet;
...
import prosayj.handwritten.mvcframework.pojo.Handler;
...
public class MyDispatcherServlet extends HttpServlet {
    ...
    private void doLoadConfig(String contextConfigLocation) {
        if (contextConfigLocation.startsWith(CLASS_PATH_PREFIX)) {
            contextConfigLocation = contextConfigLocation.replaceAll(CLASS_PATH_PREFIX, "");
        }
