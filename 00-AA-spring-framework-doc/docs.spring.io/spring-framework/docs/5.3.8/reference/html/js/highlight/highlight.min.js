...
hljs.registerLanguage("groovy", function() {
    "use strict";
    ...
    return function(n) {
        const a = e([n.C_LINE_COMMENT_MODE, n.C_BLOCK_COMMENT_MODE, n.COMMENT("/\\*\\*", "\\*/", {
                relevance: 0,
                contains: [{
                    begin: /\w+@/,
                    relevance: 0
            ...
            s = e([n.BINARY_NUMBER_MODE, n.C_NUMBER_MODE]),
            i = e([{
                begin: /"""/,
                end: /"""/
            }, {
        ...
        return {
            ...
            contains: [n.SHEBANG(), a, i, t, s, {
                ...
                contains: [a, i, t, s, "self"]
            }, {
                className: "symbol",
                begin: "^[ \t]*" + (r = "[A-Za-z0-9_$]+:", function(...e) {
