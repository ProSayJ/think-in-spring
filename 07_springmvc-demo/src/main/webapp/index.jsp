...
<div>
    ...
    <fieldset>
        <p>测试用例：SpringMVC 对原生servlet api的支持【/demo/handle02】</p>
        <a href="/demo/handle02?id=1">点击测试</a>
    </fieldset>
    <fieldset>
        <p>测试用例：SpringMVC 接收简单数据类型参数【/demo/handle03】</p>
        <a href="/demo/handle03?id=1">点击测试</a>
    </fieldset>
    <fieldset>
        <p>测试用例：SpringMVC 使用 @RequestParam 接收简单数据类型参数(形参名和参数名不一致)【/demo/handle03-2】</p>
        <a href="/demo/handle03-2?ids=1">点击测试</a>
    </fieldset>

    <fieldset>
        <p>测试用例：SpringMVC接收pojo类型参数【/demo/handle04】</p>
        <a href="/demo/handle04?id=1&name=zhangsan">点击测试</a>
    </fieldset>

    <fieldset>
        <p>测试用例：SpringMVC接收pojo包装类型参数【/demo/handle05】</p>
        <a href="/demo/handle05?user.id=1&user.name=zhangsan">点击测试</a>
    </fieldset>

    <fieldset>
        <p>测试用例：SpringMVC接收日期类型参数【/demo/handle06】</p>
