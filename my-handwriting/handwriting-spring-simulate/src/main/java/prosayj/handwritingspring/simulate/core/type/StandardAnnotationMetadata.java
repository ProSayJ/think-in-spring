...
package prosayj.handwritingspring.simulate.core.type;
...
import prosayj.handwritingspring.simulate.core.annotation.MergedAnnotations;
import prosayj.handwritingspring.simulate.core.annotation.RepeatableContainers;
import prosayj.handwritingspring.simulate.core.type.AnnotationMetadata;
import prosayj.handwritingspring.simulate.core.type.MethodMetadata;
import prosayj.handwritingspring.simulate.util.MultiValueMap;
import prosayj.handwritingspring.simulate.util.ReflectionUtils;
 ...
 * @since 2.5
 */
public class StandardAnnotationMetadata extends org.springframework.core.type.StandardClassMetadata implements AnnotationMetadata {
			...
			try {
				...
				for (Method method : methods) {
					if (isAnnotatedMethod(method, annotationName)) {
						...
						annotatedMethods.add(new org.springframework.core.type.StandardMethodMetadata(method, this.nestedAnnotationsAsMap));
					}
				}
			}
			catch (Throwable ex) {
