...
package prosayj.handwritingspring.simulate.core.type.filter;
 ...
 * @since 2.5
 */
public class AnnotationTypeFilter extends prosayj.handwritingspring.simulate.core.type.classreading.AbstractTypeHierarchyTraversingFilter {
