...
public class A_IocHelloWorldTest extends AnnotationContextSetEnv {
    ...
    public void getBeanDefinitionNames() {
        for (String beanDefinitionName : context.getBeanDefinitionNames()) {
            ...
            logger.info("getBeanDefinitionName is ==>{} , getBenan is ==>{}",beanDefinitionName,bean);
//                    , JsonUtils.toJson(bean));
        }
    }
